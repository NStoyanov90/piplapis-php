...
class ImageField extends Field
{
    ...
    public static function generate_redundant_thumbnail_url($first_image, $second_image=NULL, $width=100, $height=100,
        ...
        if ((!empty($first_image) && !($first_image instanceof ImageField)) ||
            (!empty($second_image) && !($second_image instanceof ImageField)))
        {
            throw new InvalidArgumentException('Please provide ImageField Object');
        }
