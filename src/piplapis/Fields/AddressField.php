...
class AddressField extends Field
{
    ...
    public function is_valid_country()
    {
        ...
        return (!empty($this->country) &&
            array_key_exists(strtoupper($this->country), APIUtil::$piplapi_countries));
    }
    ...
    public function is_valid_state()
    {
        ...
        return ($this->is_valid_country() &&
            array_key_exists(strtoupper($this->country), APIUtil::$piplapi_states) &&
            !empty($this->state) &&
            array_key_exists(strtoupper($this->state), APIUtil::$piplapi_states[strtoupper($this->country)]));
    ...
    public function country_full()
    {
        ...
        if (!empty($this->country))
        {
            ...
            return array_key_exists($uppedcoutnry, APIUtil::$piplapi_countries) ?
                APIUtil::$piplapi_countries[$uppedcoutnry] :
                NULL;
        }
        return;
    }
    ...
    public function state_full()
    {
        ...
        {
            return APIUtil::$piplapi_states[strtoupper($this->country)][strtoupper($this->state)];
        }
        return;
    }
}