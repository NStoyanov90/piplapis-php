...
class NameField extends Field
{
    ...
    public function is_searchable()
    {
        ...
        // search by.
        $first = APIUtil::piplapi_alpha_chars(!empty($this->first) ? $this->first : '');
        $last = APIUtil::piplapi_alpha_chars(!empty($this->last) ? $this->last : '');
        $raw = APIUtil::piplapi_alpha_chars(!empty($this->raw) ? $this->raw : '');
