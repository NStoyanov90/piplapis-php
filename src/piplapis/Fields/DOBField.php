...
use Pipl\Fields\DateRangeField;

class DOBField extends Field
{
    // Date-of-birth of A person.
    // Comes as a DateRangeField (the exact date is within the range, if the exact
    ...
    public static function from_birth_year($birth_year)
    {
        ...
        $date_range = DateRangeField::from_years_range($birth_year, $birth_year);
        return (new DOBField(array('date_range' => $date_range)));
    }
    ...
    public static function from_birth_date($birth_date)
    {
        ...
        $date_range = new DateRangeField($birth_date, $birth_date);
        return (new DOBField(array('date_range' => $date_range)));
    }
    ...
    public static function from_age($age)
    {
        ...
        # suitable for him.
        return (DOBField::from_age_range($age, $age));
    }
    ...
    public static function from_age_range($start_age, $end_age)
    {
        ...
        $date_range = new DateRangeField($start_date, $end_date);
        return (new DOBField(array('date_range' => $date_range)));
    }
}