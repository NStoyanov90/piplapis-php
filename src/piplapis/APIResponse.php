...
use Pipl\Containers\Source;
use Pipl\Containers\AvailableData;
...
class APIResponse implements JsonSerializable
{
                                ...
                                $demo_usage_current = NULL, $demo_usage_expiry = NULL)
    {
        ...
        //  sources -- A list of Source objects with full/partial match to the query.
        //  possible_persons -- An array of Person objects, each of these is an
    ...
    public static function from_array($d, $headers = array())
    {
        ...
        $response = new APIResponse($d["@http_status_code"], $query, $d["@visible_sources"],
